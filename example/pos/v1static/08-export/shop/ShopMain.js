...
ShopMain.html = `
<div>
  <button class="big" onclick="Pos.start()">新增訂單</button>
  <button class="big" onclick="Setting.start()">商店設定</button>
  <button class="big" onclick="ShopMain.todayReport()">本日報表</button>
  <button class="big" onclick="Report.start()">全部報表</button>
  <button class="big" onclick="Export.start()">匯出資料</button>
</div>
`
...
<div>
  ...
  <button class="big" onclick="Export.start()">匯出資料</button><br/><br/>
  <button class="big hidden">匯出資料</button><br/>
</div>
*/
